...
//shonax
{ _n("aa_slowwalk"), &vars::aa.slowwalkamount },
{ _n("aa_slowwalk_key"), &vars::key.slowwalk },

{ _n("aa_desync_enable"), &vars::aa.desync_enable },
{ _n("aa_pitch_type"), &vars::aa.pitch_type },

{ _n("aa_desync_swap"), &vars::aa.desync_swap },
{ _n("aa_body_lean"), &vars::aa.body_lean },
{ _n("aa_body_inverted"), &vars::aa.body_inverted },
...
{ _n("m_savekill"), &vars::misc.save_kils},

{ _n("m_screen_pocit"), &vars::misc.screen_enable },
{ _n("m_screen_size"), &vars::misc.screenpoc },
...
{ _n( "v_i_reload"), &vars::visuals.esp.reload },
