...
void c_window::render()
{
	...
	render::get().filled_box( m_bounds.x, m_bounds.y, m_bounds.w, m_bounds.h, D3DCOLOR_RGBA( 16, 16, 16, 255 ) );
	render::get().bordered_box( m_bounds.x, m_bounds.y, m_bounds.w, m_bounds.h, D3DCOLOR_RGBA( 0, 0, 0, 255 ), 1 );

	render::get().filled_box( m_tabarea.x, m_tabarea.y, m_tabarea.w, m_tabarea.h, D3DCOLOR_RGBA( 16, 16, 16, 255 ) );

	render::get().line( Vector2D( m_bounds.x + 1, m_bounds.y + 20 ), Vector2D( m_bounds.x + m_bounds.w - 1, m_bounds.y + 20 ), D3DCOLOR_RGBA( 16, 16, 16, 255 ) );

	render::get().filled_box( m_subtabarea.x, m_subtabarea.y, m_subtabarea.w, m_subtabarea.h, D3DCOLOR_RGBA( 25, 25, 25, 255 ) );

	if ( *reinterpret_cast< bool* >( g_module ) )
	{
		_( fatality, "FATALITY.WIN 2022" );
