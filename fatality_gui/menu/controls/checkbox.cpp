...
{
	_u( key, m_value );
	render::get().filled_box( m_bounds.x, m_bounds.y, CHECKBOX_HEIGHT, CHECKBOX_HEIGHT, g_cfg[ key ]->get<bool>() ? D3DCOLOR_RGBA(40, 0, 128, 255 ) : D3DCOLOR_RGBA(40, 0, 128, 255 ) );
	...
	if ( !g_cfg[ key ]->get<bool>() && anim_progress <= 0.f )
		render::get().filled_box( m_bounds.x + 1, m_bounds.y + 1, CHECKBOX_HEIGHT - 2, CHECKBOX_HEIGHT - 2, D3DCOLOR_RGBA( 40, 0, 128, ( int )( 60 * hover_progress ) ) );
