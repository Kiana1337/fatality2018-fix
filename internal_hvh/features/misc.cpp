...
void misc::soundesp( const int idx, const char* sample, const Vector& origin )
{
	if ( INRANGE( idx, 1, g_pGlobals->maxClients ) )
	{
		...
		if ( !player || !player->get_alive() || player == g_pLocalPlayer || player->GetClientClass()->m_ClassID != ClassId_CCSPlayer || !player->IsDormant() )
			return;
...
void misc::clan_tag()
{
	...
	if ( int( g_pGlobals->curtime * 3.1 ) != prevtime )
	{
		if ( prevval != int( g_pGlobals->curtime * 3.1 ) % 31 )
		{
			...
			{
				/*case 30: { _( s30, "[u.......]" ); setclantag( s30 ); break; }
				case 24: { _( s24, "[un......]" ); setclantag( s24 ); break; }
				case 23: { _( s23, "[uni.....]" ); setclantag( s23 ); break; }
				case 22: { _( s22, "[univ....]" ); setclantag( s22 ); break; }
				case 21: { _( s21, "[unive...]" ); setclantag( s21 ); break; }
				case 20: { _( s20, "[univer..]" ); setclantag( s20 ); break; }
				case 19: { _( s19, "[univers.]" ); setclantag( s19 ); break; }*/
			case 18: { _(s18, " "); setclantag(s18); break; }
			case 17: { _(s17, "f"); setclantag(s17); break; }
			case 16: { _(s16, "fa"); setclantag(s16); break; }
			case 15: { _(s15, "fat"); setclantag(s15); break; }
			case 14: { _(s14, "fata"); setclantag(s14); break; }
			case 13: { _(s13, "fatal"); setclantag(s13); break; }
			case 12: { _(s12, "fatali"); setclantag(s12); break; }
			case 11: { _(s11, "fatalit"); setclantag(s11); break; }
			case 10: { _(s10, "fatality"); setclantag(s10); break; }
			case 9: { _(s9, "fatality"); setclantag(s9); break; }
			case 8: { _(s8, "fatality"); setclantag(s8); break; }
			case 7: { _(s7, "fatality"); setclantag(s7); break; }
			case 6: { _(s6, "fatalit"); setclantag(s6); break; }
			case 5: { _(s5, "fatali"); setclantag(s5); break; }
			case 4: { _(s4, "fatal"); setclantag(s4); break; }
			case 3: { _(s3, "fata"); setclantag(s3); break; }
			case 2: { _(s2, "fat"); setclantag(s2); break; }
			case 1: { _(s1, "fa"); setclantag(s1); break; }
			case 0: { _(s0, "f"); setclantag(s0); break; }
			default:;
			}
		}
	}
